...
function FlipDigit({ value, label }) {
  return (
    <div className="flex flex-col items-center">
      <div className="relative w-full aspect-[0.82] min-h-16 max-h-28 bg-white/15 border border-white/25 backdrop-blur-sm rounded-lg sm:rounded-xl shadow-lg overflow-hidden flex items-center justify-center">
        ...
        <AnimatePresence mode="popLayout">
          <motion.span
            ...
            className="text-3xl sm:text-4xl md:text-6xl font-bold text-white tabular-nums"
      ...
      <span className="mt-2 text-[10px] sm:text-xs md:text-sm uppercase tracking-widest text-white/80 font-semibold">
        {label}
      </span>
    </div>
  )
...
export default function Countdown() {
  ...
  return (
    <div className="text-center">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-3 md:gap-6 w-full max-w-[11rem] sm:max-w-md md:max-w-xl mx-auto">
